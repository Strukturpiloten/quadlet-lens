...
| Section                            | Typed keys                                                                                                                                                                                                                                                                                                                                          |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `[Container]`                      | 78 keys; see the [coverage ledger](roadmap.md#specification-coverage-ledger)                                                                                                                                                                                                                                                                        |
...
The current manual contains exactly 12 additional container keys, 15 pod keys, 8 network keys, and no
