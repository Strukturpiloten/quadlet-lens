...
case "$(uname -m)" in
  x86_64)
    ...
    readonly taplo_checksum="8fe196b894ccf9072f98d4e1013a180306e17d244830b03986ee5e8eabeb6156"
  ...
  aarch64 | arm64)
    ...
    readonly taplo_checksum="033681d01eec8376c3fd38fa3703c79316f5e14bb013d859943b60a07bccdcc3"
...
taplo_archive="${temporary_directory}/taplo.gz"
download \
  "https://github.com/tamasfe/taplo/releases/download/${taplo_version}/taplo-linux-${release_architecture}.gz" \
  "${taplo_archive}" "${taplo_checksum}"
gzip --decompress --stdout "${taplo_archive}" > "${temporary_directory}/taplo"
install -m 0755 "${temporary_directory}/taplo" "${install_directory}/taplo"
...
printf 'Installed Taplo %s, shfmt %s, ShellCheck %s, and Hadolint %s.\n' \
  "${taplo_version}" "${shfmt_version}" "${shellcheck_version}" "${hadolint_version}"
